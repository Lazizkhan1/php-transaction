...
import { type BreadcrumbItem, type User, type CardType as CardTypeModel, type Card as CardModel } from '@/types'; // Assuming CardType is also in types
...
export default function EditCardPage() {
    const { card, users, cardTypesList, flash, errors, auth } = usePage().props as unknown as PageProps & { errors: Record<string, string>, auth: { user: User } };
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: card.card_holder + ' - ' + card.card_number.slice(-4),
    ...
    const { data, setData, put, processing, reset } = useForm({
        user_id: card.user_id || '' as number | '',
        ...
        card_type_id: card.card_type_id || '' as number | '',
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Card - ${card.card_holder}`} />
            <div className="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
                <div className="bg-card p-6 rounded-lg shadow-sm">
                    <h1 className="text-xl font-semibold mb-4">Edit Card: <span className='text-primary font-mono'>{card.card_holder} - {card.card_number.slice(-4)}</span></h1>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <Input
                                    ...
                                    step="0.01"
                                    placeholder="0.00"
                                    value={data.balance.toString()} // Ensure value is string for input
                                    required={true}
